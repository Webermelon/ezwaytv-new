...
return [
    ...
    'module_setting' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'checkbox',
                'data' => 'appconfig',
                'name' => 'media_compress_enable',
                'label' => 'Enable Media Compression',
                'rules' => 'boolean',
                'class' => '',
                'value' => '0',
                'help' => 'Enable server-side compression for images and videos (requires ffmpeg).',
                'datatype' => 'misc',
            ],
            [
                'type' => 'number',
                'data' => 'appconfig',
                'name' => 'media_compress_image_quality',
                'label' => 'Image Quality (1-100)',
                'rules' => 'nullable|integer|min:1|max:100',
                'class' => '',
                'value' => '75',
                'help' => 'Target image quality percentage for recompression.',
                'datatype' => 'misc',
            ],
            [
                'type' => 'number',
                'data' => 'appconfig',
                'name' => 'media_compress_video_crf',
                'label' => 'Video CRF (lower = higher quality)',
                'rules' => 'nullable|integer|min:18|max:35',
                'class' => '',
                'value' => '23',
                'help' => 'CRF value for x264 encoding. Lower gives higher quality and larger files.',
                'datatype' => 'misc',
            ],
            [
                'type' => 'text',
                'data' => 'appconfig',
                'name' => 'media_compress_video_preset',
                'label' => 'Video Preset',
                'rules' => 'nullable|string',
                'class' => '',
                'value' => 'slow',
                'help' => 'ffmpeg preset (ultrafast, superfast, veryfast, faster, fast, medium, slow, slower, veryslow).',
                'datatype' => 'misc',
            ],
            [
                'type' => 'text',
                'data' => 'appconfig',
                'name' => 'media_compress_audio_bitrate',
                'label' => 'Audio Bitrate (e.g. 128k)',
                'rules' => 'nullable|string',
                'class' => '',
                'value' => '128k',
                'help' => 'Target audio bitrate for transcoded videos.',
                'datatype' => 'misc',
            ],
            [
                'type' => 'checkbox',
    ...
    'elements' => [
        ...
        [
            'type' => 'checkbox', // input field type
            'data' => 'storage_settings', // data type, boolean
            'name' => 'dg_ocean', // unique name for the field
            'label' => 'Enable DigitalOcean Spaces', // label for the field
            'rules' => 'boolean', // validation rules
            'class' => '', // any class for input
            'value' => 0, // default value
            'datatype' => 'storageconfig',
        ...
        [
            ...
            'label' => 'DO Spaces Access Key', // label for the field
            'rules' => '', // validation rules
            'class' => '', // any class for input
            'value' => '', // default value
            'datatype' => 'storageconfig',
        ...
        [
            'type' => 'text', // input field type
            'data' => 'storage_settings', // data type, string
            'name' => 'do_spaces_secret', // unique name for the field
            'label' => 'DO Spaces Secret Key', // label for the field
            'rules' => '', // validation rules
            'class' => '', // any class for input
            'value' => '', // default value
            'datatype' => 'storageconfig',
        ...
        [
            'type' => 'text', // input field type
            'data' => 'storage_settings', // data type, string
            'name' => 'do_spaces_region', // unique name for the field
            'label' => 'DO Spaces Region', // label for the field
            'rules' => '', // validation rules
            'class' => '', // any class for input
            'value' => '', // default value
            'datatype' => 'storageconfig',
        ...
        [
            'type' => 'text', // input field type
            'data' => 'storage_settings', // data type, string
            'name' => 'do_spaces_bucket', // unique name for the field
            'label' => 'DO Spaces Bucket', // label for the field
            'rules' => '', // validation rules
            'class' => '', // any class for input
            'value' => '', // default value
            'datatype' => 'storageconfig',
        ...
        [
            'type' => 'text', // input field type
            'data' => 'storage_settings', // data type, string
            'name' => 'do_spaces_endpoint', // unique name for the field
            'label' => 'DO Spaces Endpoint', // label for the field
            'rules' => '', // validation rules
            'class' => '', // any class for input
            'value' => '', // default value
            'datatype' => 'storageconfig',
        ...
        [
            'type' => 'text', // input field type
            'data' => 'storage_settings', // data type, string
            'name' => 'do_spaces_url', // unique name for the field
            'label' => 'DO Spaces CDN URL', // label for the field
            'rules' => '', // validation rules
            'class' => '', // any class for input
            'value' => '', // default value
            'datatype' => 'storageconfig',
        ...
        [
            'type' => 'select', // input field type
            'data' => 'storage_settings', // data type, string
            'name' => 'do_spaces_path_style', // unique name for the field
            'label' => 'DO Spaces Use Path Style Endpoint', // label for the field
            'rules' => '', // validation rules
            'class' => '', // any class for input
            'value' => 'false', // default value
            'options' => ['false' => 'Disable', 'true' => 'Enable'], // select options
            'datatype' => 'storageconfig',
        ],
        [
            'type' => 'text', // input field type
