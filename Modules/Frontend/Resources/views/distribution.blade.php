...
<div class="dist-section">
  ...
  <div class="network-grid">
    ...
    <div class="network-card" data-reveal>
      ...
      <div class="card-body">
        Be Spire TV is a platform dedicated to inspirational and aspirational content — perfectly aligned with eZWay's mission of empowering creators and communities. Distribution on Be Spire TV connects eZWay's message to audiences seeking purposeful, uplifting programming.
      </div>
    ...
    <div class="network-card" data-reveal>
      ...
      <div class="card-body">
        A decentralized, Web3-powered streaming platform and global creator network with international reach. Fan TV Global amplifies independent voices and content creators — a long-standing distribution partner of the eZWay Network for over 15 years.
      </div>
    ...
    <div class="network-card" data-reveal>
      ...
      <div class="card-body">
        Power TV Network is a dynamic broadcast and streaming network delivering bold, powerful content to diverse audiences. eZWay's partnership with Power TV Network extends the network's reach into communities that demand strong, impactful storytelling and entertainment with purpose.
      </div>
...
<div class="platforms-strip">
  ...
  <div class="platforms-list">
    @foreach([
      'Tubi', 'Pluto TV', 'Apple TV', 'Roku', 'Fire TV',
      'Whale TV', 'iVOD', 'Be Spire TV', 'Fan TV Global', 'Power TV Network'
    ] as $platform)
