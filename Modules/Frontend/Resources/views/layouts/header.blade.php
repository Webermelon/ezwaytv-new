        ...
        <div class="container-fluid navbar-inner">
            <div class="d-flex align-items-center justify-content-between w-100 landing-header">
                <div class="d-flex gap-3 gap-xl-0 align-items-center">
                    {{-- Hide left hamburger button --}}
                    <button type="button" data-bs-toggle="offcanvas" data-bs-target="#navbar_main"
                        aria-controls="navbar_main" class="d-none btn btn-primary rounded-pill toggle-rounded-btn">
                        ...
                        <div class="d-xl-none pb-3 mb-3 px-3">
                            ...
                            <ul class="list-unstyled mb-0 border-top border-secondary pt-3">
                                ...
                                @if($navCategories->count() && isenablemodule('show_categories_menu'))
                                    <li class="py-2 px-2">
                                        <a class="text-white fw-bold d-flex align-items-center justify-content-between" data-bs-toggle="collapse" href="#categoriesSubmenu" role="button" aria-expanded="false">
                                ...
                                @endif
                                <li class="py-2 px-2">
                                    <a href="https://ppv.ezway.tv/" target="_blank" class="text-decoration-none d-block text-white">
                                        eZWay PPV
                                    </a>
                                </li>
                                <li class="py-2 px-2">
