...
@section('content')
    ...
    {{ html()->form('POST', route('backend.categories.store'))->attribute('enctype', 'multipart/form-data')->attribute('id', 'form-submit')->class('requires-validation')->attribute('novalidate', 'novalidate')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row gy-3">
                <div class="col-md-12 col-xl-3 position-relative">
                    ...
                    {{ html()->hidden('file_url')->id('file_url_image')->value(old('file_url', '')) }}
                </div>
                    ...
                    <div class="row gy-3">
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-3">
                                ...
                                {{ html()->text('name', old('name'))->class('form-control')->id('name')->placeholder('Category name')->attribute('required', 'required')->attribute('maxlength', '255')->attribute('autofocus', 'autofocus') }}
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                {{ html()->textarea('description', old('description'))->class('form-control')->id('description')->placeholder('Category description (optional)')->rows(3) }}
                            </div>
