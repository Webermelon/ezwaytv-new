            ...
            <div class="row gy-3">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="mb-3">
                        ...
                        {{ html()->date('dob', old('dob'))->class('form-control datetimepicker')->id('dob')->placeholder(__('placeholder.lbl_user_date_of_birth')) }}
                        @error('dob')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        {{ html()->text('place_of_birth', old('place_of_birth'))->class('form-control ')->id('place_of_birth')->placeholder(__('placeholder.lbl_cast_place_of_birth')) }}
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        {{ html()->textarea('bio', old('bio'))->class('form-control')->id('bio')->placeholder(__('placeholder.lbl_cast_bio'))->rows('6') }}
                        @error('bio')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
